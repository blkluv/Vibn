...
import SmSoCard from "../ui/cards/SmSoCard";
      ...
      try {
        ...
        const [songResponse, lyricsResponse, translatedLyricsResponse] =
          await Promise.all([
            ...
            axios.get(
              `${site.api}/lyric/translate?id=${currentSongId}`
            ),
          ]);
          ...
          <div
            className={cn(
              ...
              !display
                ...
                : "fixed md:relative sm:relative bottom-0 md:top-0 sm:top-0 py-0 md:py-3 sm:py-0",
              isFull === "true"
              ...
              >
                ...
                >
                  ...
                  <motion.img
                    ...
                    onClick={() => setIsFull("true")}
                    className={cn(
                      "shadow-lg mx-auto w-auto md:w-[26rem] sm:w-[28rem] object-contain item-center rounded-xl transition-all duration-500",
                      !display
                        ? "opacity-100 z-0"
                      ...
                      <h1
                        className={cn(
                          ...
                          isFull === "true"
                            ...
                            : "w-28 md:w-56 sm:w-72 text-base md:text-lg sm:text-lg mt-1"
                        )}
                      >
                        {song.name}
                      </h1>
                      <h2
                        className={cn(
                          ...
                          isFull === "true"
                            ...
                            : "w-28 md:w-56 sm:w-72 text-base md:text-lg sm:text-lg"
                        )}
                      >
                        {song.ar.map((artist) => artist.name).join(" / ")}
                      </h2>
                    ...
                    >
                      <Dialog.Root>
                        ...
                        >
                          ...
                          >
                            <Menu.Items className="absolute border border-neutral-300 dark:border-neutral-700  right-0 mt-2 w-36 md:h-40 sm:h-40 h-[13rem] overflow-y-auto py-2 text-neutral-700 dark:text-neutral-300 text-base origin-top-right bg-neutral-200/95 dark:bg-neutral-800/95 backdrop-blur-[1px] rounded-xl z-[99999]">
                              <div className="px-4 py-1 flex flex-col">
                                ...
                                <Menu.Item
                                  ...
                                  onClick={(event) => {
                                    ...
                                    router.push(
                                      `/song?id=${songIds[currentSongIndex]}`
                                    );
                                    setIsFull("false");
                                  }}
                                  className="text-center rounded-xl px-3 py-0.5"
                                ...
                                >
                                  ...
                                  >
                                    <Menu.Button className="ml-1 w-full">
                                      定时关闭
                                    </Menu.Button>
                                  </button>
                                  <Transition
                        ...
                        <Dialog.Portal>
                          ...
                          <Dialog.Content className="DialogContent fixed max-w-4xl mx-auto w-full h-screen bg-neutral-50 dark:bg-neutral-950 overflow-y-auto backdrop-blur-lg z-[999999]">
