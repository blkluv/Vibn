...
export default function MvCard({ picUrl, name, id, index, ar }) {
  ...
  return (
    ...
    >
      <div className="bg-neutral-200 dark:bg-neutral-800 rounded-xl shadow-lg w-80 md:w-96 sm:w-[27.5rem] h-48 md:h-56 sm:h-64">
        <LazyLoadImage
          effect="opacity"
          src={`${picUrl}?param=440y256`}
          className="bg-neutral-200 dark:bg-neutral-800 rounded-xl shadow-lg w-80 md:w-96 sm:w-[27.5rem] h-48 md:h-56 sm:h-64"
        />
      </div>
